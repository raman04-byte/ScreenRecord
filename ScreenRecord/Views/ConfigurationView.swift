    ...
    var body: some View {
        VStack {
            Form {
                ...
                Button(action: {
                    screenRecorder.isRecordingStream = !screenRecorder.isRecordingStream
                }) {
                    HStack {
                        Image(systemName: "record.circle")
                            .foregroundColor(screenRecorder.isRecordingStream ? .red : .primary)
                        
                        screenRecorder.isRecordingStream ?
                        Text("Stop Recording")
